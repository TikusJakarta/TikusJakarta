<div align="center">
  ...
  <img src="https://capsule-render.vercel.app/render?type=waving&color=3384FF&height=200&section=header&text=Hi, I'm Daniel 👋&fontSize=70&animation=fadeIn&fontAlignY=38" width="100%" alt="Banner" />
...
<table border="0">
  <tr>
    <td width="60%">
      <ul>
        <li>🛠 Current Project: **[Creating Task Manager with Laravel 11 and Vue 3]**</li>
        <li>🌱 Learning: Inertia.js Ecosystem & Clean Architecture</li>
        <li>👀 Focus: Building efficient Full-stack applications</li>
        <li>⚡ Fun Fact: My Neovim config has more lines than my actual code.</li>
      </ul>
    </td>
    <td width="40%">
